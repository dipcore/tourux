...
Connector.prototype.update = function() {
	...
	var start1 = [
		toUnit(start0[0] - fromCenter[0]) * this.smoothness * 500 + start0[0],
		toUnit(start0[1] - fromCenter[1]) * this.smoothness * 500 + start0[1]
	];
	var end1 = [
		toUnit(end0[0] - toCenter[0]) * this.smoothness * 500 + end0[0],
		toUnit(end0[1] - toCenter[1]) * this.smoothness * 500 + end0[1]
	];
